...
# combine
plotc <- plot1 + plot2
ggsave("./Figure2_scRNA_part/JE_combined_umap.pdf", plot = plotc, width = 20, height = 10)
plot3
ggsave("./Figure2_scRNA_part/JE_combined_umap_split.pdf", plot = plot3, width = 24, height = 10)
...
write.csv(JE_combined_markers, file = "./Figure2_scRNA_part/JE_combined_markers_20240122.csv", row.names = FALSE)
write.csv(top10, file = "./Figure2_scRNA_part/JE_combined_top10_markers_20240122.csv", row.names = FALSE)
...
ggsave("./Figure2_scRNA_part/JE_combined_markers_top10_20240122.pdf", device = "pdf",#adjust filename accordingly
...
for (i in unique(top6$cluster)) {
  ...
  if (length(genes_to_plot) > 0) {
    ...
    file_name <- paste0("./Figure2_scRNA_part/JE_combined_featureplot_RNA_cluster_", i, ".pdf")
...
write.csv(obs.counts, file = "./Figure2_scRNA_part/test.csv", row.names = TRUE)
...
```{r, DPA,message = FALSE}
obs.counts = as.matrix(read.csv("./Figure2_scRNA_part/test.csv", row.names = 1))
print(obs.counts)
...
write.csv(res.table.D3VsD0, file = "./Figure2_scRNA_part/JE_combined_res.table.D3VsD0.csv", row.names = FALSE)
write.csv(res.table.D5VsD0, file = "./Figure2_scRNA_part/JE_combined_res.table.D5VsD0.csv", row.names = FALSE)
write.csv(res.table.D5VsD3, file = "./Figure2_scRNA_part/JE_combined_res.table.D5VsD3.csv", row.names = FALSE)
...
write.csv(split_count_melt, file = "./Figure2_scRNA_part/JE_combined_harmony_cell_number_cluster_renamed.csv", row.names = FALSE)
...
ggsave("./Figure2_scRNA_part/JE_combined_harmony_Percentage_cell_in_each_cluster_renamed_unnormalized.pdf", height = 3, width = 7.5)
...
write.csv(split_count_percent_melt, file = "./Figure2_scRNA_part/JE_combined_harmony_cell_percentage_cluster_renamed.csv", row.names = FALSE)
...
ggsave("./Figure2_scRNA_part/JE_combined_harmony_Percentage_cell_in_each_cluster_renamed_normalized.pdf", height = 3, width = 7.5)
...
ggsave("./Figure2_scRNA_part/JE_combined_harmony_Percentage_cell_in_each_celltype_normalized_stack.pdf", height = 3, width = 7.5)
...
ggplot(split_count_percent_melt, aes(x = cluster_renamed, y = Percentage)) +
  ...
  theme_bw() + 
  theme(panel.grid = element_blank())
ggsave("./Figure2_scRNA_part/JE_combined_harmony_Percentage_cell_in_each_cluster_renamed_normalized_dodge.pdf", height = 3, width = 7.5)
...
ggsave("./Figure2_scRNA_part/JE_combined_harmony_heatmap_cell_proportion.pdf", height = 5, width = 7)
...
# Save the dot plot
ggsave("./Figure2_scRNA_part/JE_combined_harmony_dotplot_feature.pdf", width = 8, height = 5)
```
...
# combine
plotc <- plot1 + plot2
ggsave("./Figure2_scRNA_part/JE_combined_epi_umap.pdf", plot = plotc, width = 20, height = 10)
plot3
ggsave("./Figure2_scRNA_part/JE_combined_epi_umap_split.pdf", plot = plot3, width = 24, height = 10)
...
```{r, output tables for marker genes}
write.csv(JE_combined_epi_markers, file = "./Figure2_scRNA_part/JE_combined_epi_markers_20240122.csv", row.names = FALSE)
write.csv(top10, file = "./Figure2_scRNA_part/JE_combined_epi_top10_markers_20240122.csv", row.names = FALSE)
...
ggsave("./Figure2_scRNA_part/JE_combined_epi_markers_top10_20240122.pdf", device = "pdf",#adjust filename accordingly
       width = 30, #adjust according to the display of output
       height = 55, #adjust according to the display of output
       units = "cm")
...
for (i in unique(top6$cluster)) {
  ...
  if (length(genes_to_plot) > 0) {
      ...
      p<- FeaturePlot(JE_combined_epi, 
          ...
          print(p)
    # Construct a filename for saving
    file_name <- paste0("./Figure2_scRNA_part/JE_combined_epi_featureplot_MAGIC_SCT_celltype_", i, ".pdf")
    ggsave(filename = file_name, plot = p)
...
# Save the cell count data to a CSV file
write.csv(split_count_melt, file = "./Figure2_scRNA_part/JE_combined_epi_harmony_cell_number_celltype.csv", row.names = FALSE)
...
ggsave("./Figure2_scRNA_part/JE_combined_epi_harmony_Percentage_cell_in_each_celltype_unnormalized.pdf", height = 3, width = 7.5)
...
# Save the percentage data to a CSV file
write.csv(split_count_percent_melt, file = "./Figure2_scRNA_part/JE_combined_epi_harmony_cell_percentage_celltype.csv", row.names = FALSE)
...
ggsave("./Figure2_scRNA_part/JE_combined_epi_harmony_Percentage_cell_in_each_celltype_normalized.pdf", height = 3, width = 7.5)
...
ggplot(split_count_percent_melt, aes(x = celltype, y = Percentage)) +
  ...
  theme_bw() + 
  theme(panel.grid = element_blank())
ggsave("./Figure2_scRNA_part/JE_combined_epi_harmony_Percentage_cell_in_each_celltype_normalized_stack.pdf", height = 3, width = 7.5)
...
ggplot(split_count_percent_melt, aes(x = celltype, y = Percentage)) +
  ...
  theme_bw() + 
  theme(panel.grid = element_blank())
ggsave("./Figure2_scRNA_part/JE_combined_epi_harmony_Percentage_cell_in_each_celltype_normalized_dodge.pdf", height = 3, width = 7.5)
...
# Save the heatmap plot
ggsave("./Figure2_scRNA_part/JE_combined_epi_harmony_heatmap_cell_proportion.pdf", height = 5, width = 7)
...
# Save the dot plot
ggsave("./Figure2_scRNA_part/JE_combined_epi_harmony_dotplot_feature.pdf", width = 6.5, height = 3)
```
...
obs.counts <- obs.counts %>% remove_rownames %>% column_to_rownames(var="orig.ident")
write.csv(obs.counts, file = "./Figure2_scRNA_part/test_epi.csv", row.names = TRUE)
...
```{r, DPA,message = FALSE}
obs.counts = as.matrix(read.csv("./Figure2_scRNA_part/test_epi.csv", row.names = 1))
print(obs.counts)
## Run an example using error (p) of 0.1 and with 100,000 iterations
...
write.csv(res.table.D3VsD0, file = "./Figure2_scRNA_part/JE_combined_epi_res.table.D3VsD0.csv", row.names = FALSE)
write.csv(res.table.D5VsD0, file = "./Figure2_scRNA_part/JE_combined_epi_res.table.D5VsD0.csv", row.names = FALSE)
write.csv(res.table.D5VsD3, file = "./Figure2_scRNA_part/JE_combined_epi_res.table.D5VsD3.csv", row.names = FALSE)
...
ggsave("./Figure2_scRNA_part/JE_combined_epi_krt_basal_module_feature.pdf", device = "pdf", width = 15, height = 15, units = "cm")
...
FeaturePlot(object = object, features = "top_marker_gene1",pt.size = 0.1)+
  scale_color_viridis(discrete = FALSE, option="turbo")
ggsave("./Figure2_scRNA_part/JE_combined_epi_krt_top_module_feature.pdf", device = "pdf", width = 15, height = 15, units = "cm")
```
## 4.2 gene plot
...
ggsave("./Figure2_scRNA_part/JE_K5_epi_odam_umap.pdf")
```
...
FeaturePlot(JE_combined_epi, features = c("Krt5"),
            ...
            ncol=3, pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_epi_krt5_split.pdf", device = "pdf", width = 11, height = 4)
...
FeaturePlot(JE_combined_epi, features = c("Krt14"),
            ...
            split.by = "orig.ident",label = T,repel = T,
            ncol=3, pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_epi_krt14_split.pdf", device = "pdf", width = 11, height = 4)
...
FeaturePlot(JE_combined_epi, features = c("Procr"),
            ...
            label = T,repel = T,
             pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_epi_Procr.pdf", device = "pdf", width = 6, height = 5)
...
FeaturePlot(JE_combined, features = c("Procr"),
            ...
            label = T,repel = T,
             pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_Procr.pdf", device = "pdf", width = 6, height = 5)
...
FeaturePlot(JE_combined_epi, features = c("Procr"),
            cols = c("grey85",brewer.pal(9,"YlOrRd")),
             split.by = "orig.ident",label = T,repel = T,
            ncol=3, pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_epi_Procr_split.pdf", device = "pdf", width = 16, height = 5)
...
FeaturePlot(JE_combined, features = c("Procr"),
            cols = c("grey85",brewer.pal(9,"YlOrRd")),
             split.by = "orig.ident",label = T,repel = T,
            ncol=3, pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_Procr_split.pdf", device = "pdf", width = 16, height = 5)
...
ggsave("./Figure2_scRNA_part/Human_perio_PROCR.pdf", device = "pdf", width = 6, height = 5)
...
FeaturePlot(sce.big, features = c("PROCR"),
            cols = c("grey85",brewer.pal(9,"YlOrRd")),
             split.by = "orig.ident",label = T,repel = T,
            ncol=2, pt.size = 0.3)
ggsave("./Figure2_scRNA_part/Human_perio_PROCR_split.pdf", device = "pdf", width = 11, height = 5)
...
FeaturePlot(JE_combined_epi, features = c("Lgr5"),
            ...
            label = T,repel = T,
             pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_epi_Lgr5.pdf", device = "pdf", width = 6, height = 5)
...
FeaturePlot(JE_combined, features = c("Lgr5"),
            ...
            label = T,repel = T,
             pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_Lgr5.pdf", device = "pdf", width = 6, height = 5)
...
FeaturePlot(JE_combined_epi, features = c("Lgr5"),
            cols = c("grey85",brewer.pal(9,"YlOrRd")),
             split.by = "orig.ident",label = T,repel = T,
            ncol=3, pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_epi_Lgr5_split.pdf", device = "pdf", width = 16, height = 5)
...
FeaturePlot(JE_combined, features = c("Lgr5"),
            cols = c("grey85",brewer.pal(9,"YlOrRd")),
             split.by = "orig.ident",label = T,repel = T,
            ncol=3, pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_Lgr5_split.pdf", device = "pdf", width = 16, height = 5)
...
FeaturePlot(sce.big, features = c("LGR5"),
            cols = c("grey85",brewer.pal(9,"YlOrRd")),
            label = T,repel = T, pt.size = 0.1)
ggsave("./Figure2_scRNA_part/Human_perio_LGR5.pdf", device = "pdf", width = 6, height = 5)
...
FeaturePlot(sce.big, features = c("LGR5"),
            cols = c("grey85",brewer.pal(9,"YlOrRd")),
             split.by = "orig.ident",label = T,repel = T,
            ncol=2, pt.size = 0.3)
ggsave("./Figure2_scRNA_part/Human_perio_LGR5_split.pdf", device = "pdf", width = 11, height = 5)
...
FeaturePlot(JE_combined_epi, features = c("Lrig1"),
            ...
            label = T,repel = T,
             pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_epi_Lrig1.pdf", device = "pdf", width = 6, height = 5)
...
FeaturePlot(JE_combined, features = c("Lrig1"),
            ...
            label = T,repel = T,
             pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_Lrig1.pdf", device = "pdf", width = 6, height = 5)
...
FeaturePlot(JE_combined_epi, features = c("Lrig1"),
            cols = c("grey85",brewer.pal(9,"YlOrRd")),
             split.by = "orig.ident",label = T,repel = T,
            ncol=3, pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_epi_Lrig1_split.pdf", device = "pdf", width = 16, height = 5)
...
FeaturePlot(JE_combined, features = c("Lrig1"),
            cols = c("grey85",brewer.pal(9,"YlOrRd")),
             split.by = "orig.ident",label = T,repel = T,
            ncol=3, pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_Lrig1_split.pdf", device = "pdf", width = 16, height = 5)
...
FeaturePlot(sce.big, features = c("LRIG1"),
            cols = c("grey85",brewer.pal(9,"YlOrRd")),
            label = T,repel = T, pt.size = 0.1)
ggsave("./Figure2_scRNA_part/Human_perio_Lrig1.pdf", device = "pdf", width = 6, height = 5)
...
FeaturePlot(sce.big, features = c("LRIG1"),
            cols = c("grey85",brewer.pal(9,"YlOrRd")),
             split.by = "orig.ident",label = T,repel = T,
            ncol=2, pt.size = 0.3)
ggsave("./Figure2_scRNA_part/Human_perio_Lrig1_split.pdf", device = "pdf", width = 11, height = 5)
...
FeaturePlot(JE_combined_epi, features = c("Il24"),
            ...
            label = T,repel = T,
             pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_epi_Il24.pdf", device = "pdf", width = 6, height = 5)
...
FeaturePlot(JE_combined, features = c("Il24"),
            ...
            label = T,repel = T,
             pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_Il24.pdf", device = "pdf", width = 6, height = 5)
...
FeaturePlot(JE_combined_epi, features = c("Il24"),
            cols = c("grey85",brewer.pal(9,"YlOrRd")),
             split.by = "orig.ident",label = T,repel = T,
            ncol=3, pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_epi_Il24_split.pdf", device = "pdf", width = 16, height = 5)
...
FeaturePlot(JE_combined, features = c("Il24"),
            cols = c("grey85",brewer.pal(9,"YlOrRd")),
             split.by = "orig.ident",label = T,repel = T,
            ncol=3, pt.size = 0.3)
ggsave("./Figure2_scRNA_part/JE_combined_Il24_split.pdf", device = "pdf", width = 16, height = 5)
...
FeaturePlot(sce.big, features = c("IL24"),
            cols = c("grey85",brewer.pal(9,"YlOrRd")),
            label = T,repel = T, pt.size = 0.1)
ggsave("./Figure2_scRNA_part/Human_perio_Il24.pdf", device = "pdf", width = 6, height = 5)
...
FeaturePlot(sce.big, features = c("IL24"),
            cols = c("grey85",brewer.pal(9,"YlOrRd")),
             split.by = "orig.ident",label = T,repel = T,
            ncol=2, pt.size = 0.3)
ggsave("./Figure2_scRNA_part/Human_perio_Il24_split.pdf", device = "pdf", width = 11, height = 5)
...
FeaturePlot(sce.big, features = c("ODAM"),
            cols = c("grey85",brewer.pal(9,"YlOrRd")),
            label = T,repel = T, pt.size = 0.1)
ggsave("./Figure2_scRNA_part/Human_perio_odam.pdf", device = "pdf", width = 5, height = 4)
